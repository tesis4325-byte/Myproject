...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($errors)) {
        $sql = "INSERT INTO products (product_name, barcode, price, quantity, supplier_cost) VALUES (?, ?, ?, ?, ?)";
        if($stmt = $mysqli->prepare($sql)) {
            $stmt->bind_param("ssdds", $product_name, $barcode, $price, $quantity, $supplier_cost);
            if($stmt->execute()) {
