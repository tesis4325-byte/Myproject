<?php
	...
	$project = getProjectBySlug('project1');
	if (!$project) {
		...
		<div class="row g-5">
			...
			<div class="col-lg-5">
				...
				<div class="d-flex gap-3">
					...
					<?php if (!empty($project['repo'])): ?><a href="https://github.com/tesis4325-byte/Myproject/tree/main/LESGOO<?php echo htmlspecialchars($project['repo']); ?>" class="btn btn-outline-primary" target="_blank" rel="noreferrer"><i class="bi bi-github me-2"></i>Code</a><?php endif; ?>
				</div>
			</div>
		</div>
	</div>
